...
options(mysql = list(
  "host" = "ec2-54-89-235-193.compute-1.amazonaws.com",
  "port" = 3306,
  "user" = "fake_news",
  "password" = "42parkvale"
))
...
server <- function(input, output, session) {
  ...
  observeEvent(input$submit, {
    ...
    if (email %in% current_emails[[1]]) {
      ...
      request <- paste0("http://apilayer.net/api/check?access_key=50960b1d19e73f1dc9b16fc4d3efa567&email=",email,"&smtp=1&format=1")
